...
export class DetailsListLayout extends BaseLayout<IDetailsListLayoutProperties> {
   ...
   public async onInit(): Promise<void> {
      ...
      this.properties.detailsListColumns = this.properties.detailsListColumns
         ? this.properties.detailsListColumns
         : ([
              {
                 name: "Title",
                 value: '<a class="iexp-ana" href="{{slot item @root.slots.PreviewUrl}}" target="_blank" style="color: {{@root.theme.semanticColors.link}}">\n\t{{slot item @root.slots.Title}}\n</a>',
      ...
      this.properties.isCompact =
         this.properties.isCompact !== null &&
         this.properties.isCompact !== undefined
            ? this.properties.isCompact
            : false;
      this.properties.showFileIcon =
         this.properties.showFileIcon !== null &&
         this.properties.showFileIcon !== undefined
            ? this.properties.showFileIcon
            : true;
      this.properties.fieldIconExtension = this.properties.fieldIconExtension
         ? this.properties.fieldIconExtension
         : "FileType";
      this.properties.enableGrouping =
         this.properties.enableGrouping !== null &&
      ...
      this.properties.groupByField = this.properties.groupByField
         ...
         : "";
      this.properties.additionalGroupByFields = this.properties
         .additionalGroupByFields
         ? this.properties.additionalGroupByFields
         : [];
      this.properties.groupsCollapsed =
         this.properties.groupsCollapsed !== null &&
         this.properties.groupsCollapsed !== undefined
            ? this.properties.groupsCollapsed
            : true;
   ...
   public getPropertyPaneFieldsConfiguration(
      ...
      let availableOptions: IComboBoxOption[] = availableFields.map(
         (fieldName) => {
      ...
      let sortableFields = [];
      if (dataContext) {
         sortableFields = dataContext.sorting.selectedSortableFields.map(
            (field) => {
               return {
                  key: field,
                  text: field,
      ...
      let propertyPaneFields: IPropertyPaneField<any>[] = [
         this._propertyFieldCollectionData(
            "layoutProperties.detailsListColumns",
            {
               manageBtnLabel:
                  strings.Layouts.DetailsList.ManageDetailsListColumnLabel,
               key: "layoutProperties.detailsListColumns",
               panelHeader:
                  strings.Layouts.DetailsList.ManageDetailsListColumnLabel,
               panelDescription:
                  strings.Layouts.DetailsList
                     .ManageDetailsListColumnDescription,
               enableSorting: true,
               ...
               fields: [
                  ...
                  },
                  {
                     ...
                     defaultValue: false,
                     title: strings.Layouts.DetailsList
                        .UseHandlebarsExpressionLabel,
                  },
                  {
                     id: "minWidth",
                     ...
                     onCustomRender: (
                        ...
                        return React.createElement(
                           ...
                           React.createElement(AsyncCombo, {
                              ...
                              placeholder:
                                 !item.valueSorting && sortableFields.length > 0
                                    ? strings.Layouts.DetailsList
                                         .ValueSortingColumnLabel
                                    : strings.Layouts.DetailsList
                                         .ValueSortingColumnNoFieldsLabel,
      ...
      if (this.properties.enableGrouping) {
         propertyPaneFields.push(
            ...
            this._propertyFieldCollectionData(
               "layoutProperties.additionalGroupByFields",
               {
                  manageBtnLabel:
                     strings.Layouts.DetailsList.AdditionalGroupByButtonLabel,
                  key: "layoutProperties.additionalGroupByFields",
                  panelHeader:
                     strings.Layouts.DetailsList.AdditionalGroupByFieldsLabel,
                  panelDescription:
                     strings.Layouts.DetailsList
                        .AdditionalGroupByFieldsDescription,
                  enableSorting: true,
                  tableClassName: commonStyles.additionalGroupByFieldsTable,
                  label: strings.Layouts.DetailsList
                     .AdditionalGroupByFieldsLabel,
                  value: this.properties.additionalGroupByFields,
                  disabled:
                     !this.properties.enableGrouping ||
                     !this.properties.groupByField ||
                     this.properties.groupByField.length === 0,
                  fields: [
                     {
                        id: "value",
                        title: strings.Layouts.DetailsList.ValueColumnLabel,
      ...
      propertyPaneFields.push(
         PropertyPaneToggle("layoutProperties.enableStickyHeader", {
            label:
               strings.Layouts.DetailsList.EnableStickyHeader ||
      ...
      if (this.properties.enableStickyHeader) {
         propertyPaneFields.push(
            PropertyFieldNumber("layoutProperties.stickyHeaderListViewHeight", {
               ...
               maxValue: 5000,
               minValue: 200,
               value: this.properties.stickyHeaderListViewHeight
                  ? this.properties.stickyHeaderListViewHeight
                  : 500,
   ...
   public onPropertyUpdate(propertyPath: string, newValue: any, oldValue: any) {
      ...
      if (
         propertyPath.localeCompare("layoutProperties.enableStickyHeader") === 0
      ) {
